...
import pytest
from mongo_manager import find_in_nested_dict, create_nested_dict, maybe_int
...
def test_find_in_nested_dict(*, find_in: dict, path: str | list[str], default: Any, expected_result: Any) -> None:
